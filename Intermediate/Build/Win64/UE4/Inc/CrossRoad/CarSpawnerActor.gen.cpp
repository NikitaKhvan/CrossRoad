...
#include "CrossRoad/CarSpawnerActor.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeCarSpawnerActor() {}
// Cross Module References
	CROSSROAD_API UClass* Z_Construct_UClass_ACarSpawnerActor_NoRegister();
	CROSSROAD_API UClass* Z_Construct_UClass_ACarSpawnerActor();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_CrossRoad();
	COREUOBJECT_API UClass* Z_Construct_UClass_UClass();
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
// End Cross Module References
	void ACarSpawnerActor::StaticRegisterNativesACarSpawnerActor()
	{
	}
	UClass* Z_Construct_UClass_ACarSpawnerActor_NoRegister()
	{
		return ACarSpawnerActor::StaticClass();
	}
	struct Z_Construct_UClass_ACarSpawnerActor_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_ACarSpawnerActor_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_AActor,
		(UObject* (*)())Z_Construct_UPackage__Script_CrossRoad,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACarSpawnerActor_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "CarSpawnerActor.h" },
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_ACarSpawnerActor_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<ACarSpawnerActor>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ACarSpawnerActor_Statics::ClassParams = {
		&ACarSpawnerActor::StaticClass,
		"Engine",
		&StaticCppClassTypeInfo,
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_ACarSpawnerActor_Statics::PropPointers,
		nullptr,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_ACarSpawnerActor_Statics::PropPointers),
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_ACarSpawnerActor_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ACarSpawnerActor_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_ACarSpawnerActor()
	{
		static UClass* OuterClass = nullptr;
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ACarSpawnerActor_Statics::ClassParams);
		}
		return OuterClass;
	}
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_ACarSpawnerActor(Z_Construct_UClass_ACarSpawnerActor, &ACarSpawnerActor::StaticClass, TEXT("/Script/CrossRoad"), TEXT("ACarSpawnerActor"), false, nullptr, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(ACarSpawnerActor);
