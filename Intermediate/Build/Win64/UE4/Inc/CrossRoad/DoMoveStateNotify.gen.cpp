...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_StartSound_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_StartSound;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDoMoveStateNotify_Statics::NewProp_StartSound_MetaData[] = {
		{ "Category", "Sound" },
		{ "ModuleRelativePath", "DoMoveStateNotify.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDoMoveStateNotify_Statics::NewProp_StartSound = { "StartSound", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDoMoveStateNotify, StartSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDoMoveStateNotify_Statics::NewProp_StartSound_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDoMoveStateNotify_Statics::NewProp_StartSound_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDoMoveStateNotify_Statics::NewProp_EndSound_MetaData[] = {
		{ "Category", "Sound" },
		{ "ModuleRelativePath", "DoMoveStateNotify.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDoMoveStateNotify_Statics::NewProp_EndSound = { "EndSound", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDoMoveStateNotify, EndSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDoMoveStateNotify_Statics::NewProp_EndSound_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDoMoveStateNotify_Statics::NewProp_EndSound_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDoMoveStateNotify_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDoMoveStateNotify_Statics::NewProp_StartSound,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDoMoveStateNotify_Statics::NewProp_EndSound,
	};
	...
	IMPLEMENT_CLASS(UDoMoveStateNotify, 2043203112);
